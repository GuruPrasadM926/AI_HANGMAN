...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with left:
        ...
        bc = "#47ff8a" if col == "green" else "#e8ff47" if col == "yellow" else "#ff4757"
        st.markdown(f"<div style='text-align:center;margin:6px 0'><span style='background:#0f0f1a;border:1px solid {bc};border-radius:2px;padding:3px 12px;font-size:0.62rem;letter-spacing:0.2em;color:{bc}'>WRONG: {wc}/{MAX_WRONG}</span></div>", unsafe_allow_html=True)
